document.addEventListener('DOMContentLoaded', function() {
  ...
  if(conteudo === 'pascoal1') {
    ...
    sinopse.innerHTML = 'ㅤUm advogado falido, um crime sem culpado e uma depressão profunda. Na primeira parte de "O Caso da Rua Pascoal", acompanhamos o início da jornada do Dr.Marcus em busca de provar sua inocência (ou não).'
    ...
    sinopse.innerHTML = 'ㅤUm advogado falido, um crime sem culpado e uma depressão profunda. No primeiro volume de "O Caso da Rua Pascoal", acompanhamos o início da jornada do Dr.Marcus em busca de provar sua inocência (ou não).'
    ...
    sinopse.innerHTML = 'ㅤUma jovem mulher prestes a se casar enfrenta o desaparecimento súbito de seu noivo soldado. Em meio à incerteza, ela prova a profundidade de seu amor e a força de sua devoção.'
